...
describe('#newBLah()', function() {
    ...
    context('All The same value within bounds', function() {
        it('should return 10', function() {
            expect(func.newTest(10, 10, 10, 10, 10)).to.equal(10);
        })

        it('should return 100', function() {
            expect(func.newTest(100, 100, 100, 100, 100)).to.equal(100);
        })

        it('should return 0', function() {
            expect(func.newTest(0, 0, 0, 0, 0)).to.equal(0);
        })
    })

    context('Using numbers out of bounds', function() {
        it('should return 76', function() {
            expect(func.newTest(1000, 10, 10, 10, 10)).to.equal(76);
        })

        it('should return 87', function() {
            expect(func.newTest(100, 100, -100, 100, 100)).to.equal(87);
        })
    })
})
